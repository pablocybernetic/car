...
<head>
    ...
    <title>Home - Dankin Holdings</title>
...
<body>
    <nav class="navbar navbar-light navbar-expand bg-light navigation-clean">
        <div class="container" id="header"><a class="navbar-brand" href="#" style="color: rgba(114,22,77,0.9)">Dankin Holdings <span style="color:black">Car Dealership</span></a>
        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    ...
                    <h2 style="color: rgba(0,0,0,1);">Dankin Holdings - the first buy limo-MARKET.</h2>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    ...
                    <h4 style="color: rgba(0, 0, 0, 0.49);">Dankin Holdings brings you all range of premium cars at your service.</h4>
                </div>
            </div>
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    ...
                    <h4 style="color: rgba(0, 0, 0, 0.49);">All dealerships care about their customers but Dankin Holdings takes it to a whole new level.</h4>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="assets/img/e1m.jpg">
                        <h5>Elon Musk</h5>
                        <h5>CEO- TESLA, INC.</h5>
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"Team Dankin Holdings has all physics to be the greatest car dealer of all times."</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="assets/img/hb.jpg">
                        ...
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"If anyone ask me about the Dankin HoldingsCars, I'd just say One Word - ELEGANT."</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="assets/img/s6d.jpg">
                        ...
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"Whenever I visit Dankin Holdings, I feel like Lamborghini is just a portion of it."</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 my-auto h-100 text-center text-lg-left">
                    ...
                    <p class="text-left text-muted small mb-4 mb-lg-0" style="color: rgb(248,249,250);">© Dankin Holdings. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </footer>
